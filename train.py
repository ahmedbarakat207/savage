...
def main():
    ...
    training_args = TrainingArguments(
        output_dir=out_dir,
        per_device_train_batch_size=2 if args.kaggle else 1,
        per_device_eval_batch_size=2 if args.kaggle else 1,
        gradient_accumulation_steps=4 if args.kaggle else 8,
        gradient_checkpointing=True,
        learning_rate=2e-4,
        logging_steps=10 if args.kaggle else 1,
        max_steps=10 if args.quick_test else 500,
